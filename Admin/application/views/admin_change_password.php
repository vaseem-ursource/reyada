...
<div class="row">
              ...
              <div class="col-md-6  col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Admin User<small>Change Password</small></h2>
                    ...
                    <?php endif; ?>
                    <form  enctype="multipart/form-data" action="<?php echo base_url('AdminUsers/UpdatePassword');?>" method="post" class="form-horizontal form-label-left input_mask"> 
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" hidden>
                        <input type="text" name="admin_user_id" value="<?=$AdminUserId?>" id="admin_user_id" hidden>
                    </div>

...
<!--==========================
    Intro Section
  ============================-->
  <section id="intro" class="clearfix align-middle filter" style="background:url('image/articles/article2.jpg') center  no-repeat;background-size: cover;height:60vh;">
      ...
      <div class="container">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 wow fadeInUp p-1 d-flex">
                        <div class="card shadow-sm">
                            <img class="card-img-top" src="image/articles/a1.jpeg" height="250px" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 col-md-6 wow fadeInUp p-1 d-flex lap">
                        <div class="card shadow-sm">
                            <img class="card-img-top" src="image/articles/a4.jpg" height="250px" alt="Card image cap">
                            <div class="card-body">
                                <small>22, Jan 19</small>
                                <h6 class="card-title pt-1"><b>Lorem Ipsum Neque porro</b></h6>
                    ...
                    <div class="col-lg-6 col-md-6 wow fadeInUp p-1 d-flex lap">
                        <div class="card shadow-sm">
                            <img class="card-img-top" src="image/articles/a2.jpg" height="250px" alt="Card image cap">
                            <div class="card-body">
                                <small>22, Jan 19</small>
                                <h6 class="card-title pt-1"><b>Lorem Ipsum Neque porro</b></h6>
                    ...
                    <div class="col-lg-6 col-md-6 wow fadeInUp p-1 d-flex lap">
                        <div class="card shadow-sm">
                            <img class="card-img-top" src="image/articles/a3.jpg" height="250px" alt="Card image cap">
                            <div class="card-body">
                                <small>22, Jan 19</small>
                                <h6 class="card-title pt-1"><b>Lorem Ipsum Neque porro</b></h6>
            ...
            <div class="col-lg-3 col-md-3 wow fadeInUp p-1 lap">
                  <img class="" width="100%" height="200px" src="image/articles/a2.jpg" alt="Card image cap">

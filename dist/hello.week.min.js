    ...
    var i = s(1),
        ...
        n = function() {
            ...
            return Object.defineProperty(t, "cssClasses", {
                ...
                var t = [];
                this.calendar.period && (this.calendar.period.innerHTML = this.monthsAsString(this.date.getMonth())), this.calendar.week.textContent = "";
               ...
               var  minutes = d.getMinutes().toString().length == 1 ? '0'+d.getMinutes() : d.getMinutes();
                ...
                this.calendar.periodtime && (this.calendar.periodtime.innerHTML = hours+':'+minutes), this.calendar.week.textContent = "";
                this.calendar.periodyear && (this.calendar.periodyear.innerHTML = this.date.getFullYear()), this.calendar.week.textContent = "";

  ...
  ============================-->
          ...
          <div id="qnimate" class="off">
                  ...
                  <footer id="footer" class="section-bg p-0 lap">
                    <div class="container-fluid section-bg pb-4 row position-absolute" style="bottom:0px;width:-webkit-fill-available;">
                      <div class="col-md-6">
...
$("#addClassMob").click(function () {
  ...
  Sign in and see what you’ve missed!
	  <br><br>
	  <a href="#Login" style="color:white;"><span class="align-middle" data-toggle="modal" data-target="#modalLogin">LOGIN</span> <i class="fa fa-angle-right fa-2x pl-1 align-middle"></i></a>
	  </small></h6>
    </div>
  </div>
  ...
  <article>
       ...
       <div class="firstSignup">
        ...
        <div class="col-md-6">
         ...
         <br><br><br><br>
         <div class="col-md-12">
         <a href="#" style="color:black;" id="continuebtn" class="float-left"><span class="align-middle">CONTINUE</span> <i class="fa fa-angle-right fa-2x pl-1 align-middle"></i></a>
         </div>
          ...
          <br><br>
	        For further questions and inquiries<br>
                  +(965) 2297 0270<br>
                    info@reyada.co
	        <br><br>
	        <a href="./" style="color:black;"><span class="align-middle" id ="homeModal">HOME</span> <i class="fa fa-angle-right fa-2x pl-1 align-middle"></i></a>
	        </small></h6>
        </div>
       </div>
      </section>

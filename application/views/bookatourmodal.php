               ...
               <div>
                  <form style="width:80%; padding-top: 12%;">
                     ...
                     <div class="row text-left">
                        <div class="col-md-6">
                           <div class="group">
                              <input id="t_name" placeholder="Full Name" type="text"><span class="highlight"></span><span class="bar"></span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="group">
                              <input id="t_address" placeholder="Full Address" type="text"><span class="highlight"></span><span class="bar"></span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="group">
                              <input id="t_email"  placeholder="Email" type="email"><span class="highlight"></span><span class="bar"></span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="group">
                              <input id="t_area" placeholder="Area" type="text"><span class="highlight"></span><span class="bar"></span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="group">
                              <input id="t_mobile" placeholder="Phone" type="text"><span class="highlight"></span><span class="bar"></span>
                           </div>
                        </div>
                        <div class="col-md-6">

      ...
      <div class="col-sm-4 col-xs-12" style="position:relative;margin-top:5px;">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a class="btn custom-button-bl" <?= ($this->session->userdata('is_logged_in')) ? "style='width:100px;display:none;'" : "style='width:100px;'"; ?> style="width:100px;" href="<?= base_url() ?>main/book_events/<?= $event->Id ?>/<?= str_replace(array("'", "\""," ",":",";","/","|", "&quot;"), '-', strtolower($event->Name))?>"  style="color:black;" class="float-left">Get Tickets</a>
          </div>
        </div>
      </div>
      <?php }}

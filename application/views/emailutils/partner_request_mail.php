                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 20px;">
                                        Partnership Request From <b><?= $userdata['p_full_name'] ?></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <b>User Details: </b><br><br>
                                        <b>Name:</b> <?= $userdata['p_full_name'] ?><br><br>
                                        <b>Email:</b> <?= $userdata['p_email'] ?><br><br>
                                        <b>Mobile:</b> <?= $userdata['p_phone'] ?><br><br>
                                        <b>Services Offered:</b> <?= $userdata['p_services'] ?><br><br>   
                                        <b>Company Name:</b> <?= $userdata['p_company_name'] ?><br><br>  
                                    </td>
                                </tr>
                            </table>
                        </td>

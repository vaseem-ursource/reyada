                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 20px;">
                                        User <b><?= $userdata[0]->FullName ?></b> has requested for a password change.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <b>User Details:</b><br><br>
                                        <b>Full Name:</b> <?= $userdata[0]->FullName ?><br><br>
                                        <b>Email:</b> <?= $email ?><br><br>
                                        <b>Location:</b> <?= $userdata[0]->InvoicingBusinessName ?><br><br>

 ...
 */
$config['site_title'] = "Lugmah";       // Site Title, example.com
$config['admin_email'] = "admin@lugma.com"; // Admin Email, admin@example.com
$config['info_email']  = "info@lugmah.com"; // Admin Email, admin@example.com
...
$config['otp_activation'] = FALSE;                // OTP Activation for registration
